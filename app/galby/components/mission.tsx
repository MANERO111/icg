  ...
  return (
    <section className="bg-white  px-4 max-w-7xl mx-auto font-sans text-[#1a1a1a]">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
        <div className="w-full h-60 md:h-80 overflow-hidden rounded-2xl shadow-sm">
          <Image
        ...
        <div className="space-y-3 md:pl-6 max-md:text-center">
          <h2 className="text-xl font-bold uppercase tracking-wider text-black">
            MISSION
          </h2>
          <p className=" md:text-[16px] text-[14px] leading-relaxed text-gray-900">
      ...
      <div className="bg-[#f9fafc] rounded-3xl mb-10 p-5 md:p-14 text-center">
        <div className="mb-12">
          <h2 className="md:text-xl text-[14px] font-bold uppercase tracking-wide text-black md:mb-2">
            UNE APPROCHE DERMOCOSMÉTIQUE COMPLÈTE
          </h2>
          <p className="md:text-[17px] text-[12px] text-gray-600">
            Galby Dermatech repose sur 3 piliers essentiels
          </p>
        </div>

        {/* 3 Pillars Grid */}
        <div className="grid grid-cols-3 gap-12 md:gap-6 max-w-4xl mx-auto">
          {/* Pillar 1: La Science */}
          <div className="flex flex-col items-center">
            <div className="md:w-24 md:h-24 w-10 h-10 rounded-full md:bg-[#ebeeef] flex items-center justify-center mb-5">
              <Image 
            ...
            <h3 className="md:text-[17px] text-[12px] font-bold uppercase tracking-wide text-black mb-2">
              LA SCIENCE
            </h3>
            <p className="md:text-[16px] text-[12px] text-gray-900 leading-relaxed md:max-w-[200px]">
