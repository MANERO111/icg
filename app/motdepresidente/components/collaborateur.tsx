    ...
    <section className="bg-white py-16 px-6 md:px-16 max-w-6xl mx-auto">
      ...
      <div className="flex items-start gap-5 mb-14">
        ...
        <div className="flex flex-col gap-1 flex-shrink-0 mt-1">
          <Quote className="text-[#e63660] w-20 h-20" />
        </div>
        <h2 className="text-2xl md:text-3xl font-medium uppercase tracking-wide text-gray-900 ">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        {/* Left: Letter */}
        <div className="flex-1 text-gray-900 text-md md:text-lg text-justify">
        ...
        */}
        <div className="w-full md:w-[50%] flex-shrink-0 relative ">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg bg-gray-200 w-full">
            <Image
          ...
          <div className="absolute -bottom-10 left-4 right-4 bg-[#e0296a] rounded-xl px-5 py-4 shadow-xl">
            ...
            <p className="text-white/80 text-xs font-sans mt-2 leading-relaxed">
