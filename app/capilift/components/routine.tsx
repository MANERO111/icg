...
export default function PdvRoutine() {
  return (
    <section className="bg-white py-12 px-4 max-w-7xl mx-auto font-sans text-[#1a1a1a]">
      ...
      style={{ backgroundImage: "url('/img/capilift_ps.png')" }}
      >
        {/* Main Header */}
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          <p className="text-[15px] md:text-[16px] text-gray-900 leading-relaxed">
            DentYucral propose une routine adaptée :
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-y-0 text-center relative z-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[12px] font-semibold uppercase text-gray-800 tracking-wider leading-tight">
                <span className='font-grey-900 font-semibold'>Nettoyer</span>
                Shampoing énergisant
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[12px] font-semibold uppercase text-gray-800 tracking-wider leading-tight max-w-[140px]">
                <span className='font-grey-900 font-semibold'>Traiter</span>
                Lotion anti-chute
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[12px] font-semibold uppercase text-gray-800 tracking-wider leading-tight max-w-[160px]">
                <span className='font-grey-900 font-semibold'>Protéger / sublimer</span>
                Coloration Capilift
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[12px] font-semibold uppercase text-gray-800 tracking-wider leading-tight max-w-[130px]">
                Maintenir une <br />
                hygiène optimale
              </p>
            </div> */}
