...
const values = [
  {
    icon: <Image src="/img/confiance.png" alt="confiance" width={55} height={55} className="w-[55px] h-[55px] object-contain flex-shrink-0" />,
    title: "CONFIANCE",
    description: "Des relations solides et durables",
  },
  {
    icon: <Image src="/img/accompagnement.png" alt="accompagnement" width={45} height={45} className="w-[45px] h-[45px] object-contain flex-shrink-0" />,
    title: "ACCOMPAGNEMENT",
    description: "Un suivi stratégique et terrain",
  },
  {
    icon: <Image src="/img/clarte.png" alt="clarte" width={50} height={50} className="w-[50px] h-[50px] object-contain flex-shrink-0" />,
    title: "CLARTÉ",
      ...
      <div className="flex flex-col-reverse md:flex-row gap-8 md:gap-16 items-center w-full md:w-[90%] mx-auto mb-10 md:mb-14">
        ...
        <div className="flex-1 space-y-4 text-center md:text-left w-full font-sans">
          ...
          <h2 className="text-[1.8rem] sm:text-3xl md:text-5xl font-bold text-[#e0296a] uppercase leading-[1.15] md:leading-normal">
            ICG construit des Relations durables Avec ses partenaires
          </h2>
