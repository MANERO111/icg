  ...
  return (
    <section className="w-full max-w-[80%] mx-auto py-14 px-6 text-center">
      <p className="text-gray-800 text-[22px] leading-relaxed font-medium">
        ...
        reflète cette culture interne fondée sur <strong className="font-bold">
        la cohésion, l&apos;excellence, le respect, la passion et la détermination.</strong>
        Cette philosophie nourrit autant notre manière de travailler que notre manière de créer.
      </p>
    </section>  
  );
}
