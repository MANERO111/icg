...
export default function HeroSection() {
  return (
    <div 
      ...
      style={{ 
        backgroundImage: "url('/img/magiclear_bg.png')" 
      }}
    >
      ...
      <div className="absolute bottom-0 md:bottom-4 left-1/2 -translate-x-1/2 z-10 w-[85%] sm:w-[70%] md:w-auto flex justify-center items-end select-none">
        <img 
          ...
          className="object-contain object-bottom max-h-[220px] sm:max-h-[300px] md:max-h-[370px]"
          draggable="false"
        />
      </div>

      {/* --- BOTTOM LEFT: DECOUVRIR & SOCIAL BUTTONS --- */}
      <div className="absolute bottom-4 sm:bottom-8 right-4 sm:right-8 md:right-12 z-20 flex flex-col gap-2.5 sm:gap-3">
